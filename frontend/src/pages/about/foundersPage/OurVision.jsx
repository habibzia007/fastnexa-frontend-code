  ...
  return (
      <>
        ...
        <div className=" max-w-[1130px] mx-auto flex flex-col lg:flex-row w-full mt-10">
          {/* Left side - Image */}
          <div className="flex-1 flex md:justify-end justify-center items-start p-4 gap-x-10">
            <img
            ...
            <div className="flex-1 flex flex-col ">
              <div className="flex flex-col md:w-[30rem] mt-4 lg:mb-6">
                ...
                <p className="font-Poppins text-[#4C4D56] mb-4  text-sm leading-7 lg:text-base lg:leading-7 text-center lg:text-left">
                  At FAST NEXA, our journey began with a simple yet powerful vision: to harness the
                  transformative power of technology to solve real-world challenges and drive positive change. This vision was born
                  out of the passion, determination, and entrepreneurial spirit of our founder, Maj Gen Ghulam Mustafa
                  Kausar ®, Hilal i Imtiaz (M).
                </p>
              </div>
            </div>
          </div>
        ...
        <div className=" max-w-[1130px] mx-auto flex justify-center lg:justify-start md:px-5 px-10  mb-16">
          <p className="font-Poppins text-[#4C4D56] text-sm leading-7 lg:text-base lg:leading-7  text-center lg:text-left">
            Maj Gen Ghulam Mustafa Kausar (R) embarked on the path of entrepreneurship with a
            deep-seated belief in the potential of technology to reshape industries and improve lives. Inspired by the rapid
            advancements in artificial intelligence and its ability to revolutionize business processes, Maj Gen Ghulam
            Mustafa Kausar (R) set out to create a company that would lead the charge in leveraging AI to unlock new
            ...
            founded FAST NEXA, laying the foundation for what would soon become a beacon of innovation in the world of IT
            software. From the outset, Maj Gen Ghulam Mustafa Kausar (R) instilled a culture of creativity,
            collaboration, and excellence, assembling a team of like-minded individuals dedicated to pushing the boundaries
            ...
            the complexities of a rapidly evolving industry to overcoming obstacles on the path to success, Maj Gen
            Ghulam Mustafa Kausar (R) and the FAST NEXA team have remained steadfast in their commitment to innovation
            ...
            principles and values. The future holds endless possibilities, and we are excited to continue shaping it
            together with our clients, partners, and team members. With innovation as our compass and impact as our
