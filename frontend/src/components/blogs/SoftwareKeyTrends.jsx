...
const SoftwareKeyTrends = () => {
    return (
        <main className=" w-full bg-[#FFFFFF]">
            <Navbar />
            <Banner text={"Navigating the Future of Software Development: Key Trends and Technologies"} />
            <SoftwareTrendsContent />
            <TechnologyStack />
            <ContactUs />
            <Footer />
        </main>
...
export default SoftwareKeyTrends;
