...
//             business idea.
//           </p>
//           {/* please implement that slider here on the gaven images while maintian there stylig  */}
//           <div className="flex gap-4 mt-6 justify-center sm:justify-start flex-wrap sm:flex-nowrap">
//             <img className="w-20 h-10 lg:w-20 lg:h-12" src={nodejs} alt="Node.js" />
//             <img className="w-20 h-10 lg:w-20 lg:h-12" src={reactjs} alt="React.js" />
//             <img className="w-20 h-10 lg:w-20 lg:h-12" src={angular} alt="Angular" />
//             <img className="w-20 h-10 lg:w-20 lg:h-12" src={python} alt="Python" />
//             <img className="hidden lg:block w-20 h-10 lg:w-20 lg:h-12" src={dotnet} alt=".NET" />
//             <img className="hidden lg:block w-20 h-10 lg:w-20 lg:h-12" src={laravel} alt="Laravel" />
//           </div>
//           <button className="mt-6 lg:mt-12 py-3 px-6 lg:py-4 lg:px-8 font-lato text-xs lg:text-base text-white bg-orange-600 rounded-md hover:bg-transparent hover:text-orange-600 hover:ring-1 hover:ring-orange-600 transition-colors duration-300">
//             Discover More
//           </button>
//         </div>
//         {/* Right Side */}
