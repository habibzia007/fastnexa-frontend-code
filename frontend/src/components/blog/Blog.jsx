...
const Blog = ({data, baseURL}) => {
    ...
    return (
        <div className="relative w-full group transition-all duration-300 ease-in-out">
            ...
            <Link to={`/blogs/${slug}/${data.id}`}
                  className="shadow-md absolute lg:min-h-[200px] md:min-h-[130px]  min-h-[164px] md:-bottom-[50%] -bottom-[80%] left-3 right-3 bg-white p-4 sm:p-6 md:p-4 lg:p-8 rounded-b-lg transition-shadow duration-300 ease-in-out hover:transition-all group-hover:shadow-[0px_3px_0px_rgba(255,101,0)]">
                <div className="flex flex-col justify-between lg:min-h-[130px] min-h-[120px]">
                    <div>
                        <div
                            ...
                            <div className="flex items-center space-x-1">
                                ...
                                <span
                                    className="text-[.5rem] md:text-[.5rem] lg:text-[.7rem] lg:leading-5 font-Poppins">{data.blog_author_name}</span>
                            </div>
                            <div className="flex items-center space-x-1">
                        ...
                        <h3 className="font-Poppins text-base sm:text-lg md:text-[0.75rem] md:leading-5 lg:text-[1.25rem] lg:leading-6 font-semibold text-[#0E0E0E] group-hover:text-[#FF6500] transition-colors duration-300 line-clamp-3">
                            {data.blog_title}
                        </h3>
                    </div>
