...
const Hero = () => {
  ...
  return (
    <div
      className="relative h-[917px] w-[1519px] mx-auto "
      ...
      <div className=" flex flex-col gap-10">
        ...
        <div className="sm:max-w-[585.7px] sm:h-[84px] pt-[150px]  sm:ml-[121px]">
          <p className="font-Poppins font-medium sm:text-[16.22px] sm:leading-[27.58px] text-left text-white">
            We are committed to unlocking this potential for you. the future is
            defined by the limitless capabilities of Artificial Intelligence
            (AI). We dedicated to delivering innovative solutions with your
            goals.
          </p>
        </div>
        <div className="flex items-center gap-7 sm:max-w-[585.7px] pt-[90px] sm:ml-[121px]">
          <button className="flex items-center justify-center w-[209px] h-[52px] font-Poppins font-medium text-[17.85px] text-white leading-[23.2px] bg-gradient-to-r from-orange-500 via-orange-400 to-yellow-200 rounded-full transition duration-300 ease-in-out transform hover:scale-105">
            Contact Now <img className="w-[19.47px]" src={chevron} alt="" />
          </button>
          <button className="flex items-center justify-center w-[173px] h-[46px] font-Poppins font-medium text-[17.85px] text-white leading-[23.2px] bg-transparent ring-2 ring-white rounded-full transition duration-300 ease-in-out transform hover:bg-orange-400 ">
            Learn More
          </button>
        </div>
