...
//   return (
//     <div className="relative h-[917px]  w-full " style={backgroundImageStyle}>
...
//           <div className="lg:max-w-[636px] lg:h-[228px] pt-[150px]  ">
//             <h1 className="font-inter font-bold lg:text-[68px] lg:leading-[75.5px] text-left text-white">
//               We Transform <br />
//               Idea into
//               <br />
...
//             </h1>
//           </div>
//           <div className="lg:max-w-[585.7px] lg:h-[84px] pt-[150px]  ">
//             <p className="font-Poppins font-medium lg:text-[16.22px] lg:leading-[27.58px] text-left text-white">
//               We are committed to unlocking this potential for you. the future
//               is defined by the limitless capabilities of Artificial
...
//             </p>
//           </div>
//           <div className="flex items-center gap-7 lg:max-w-[585.7px] pt-[90px] ">
