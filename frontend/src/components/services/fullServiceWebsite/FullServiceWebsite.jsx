...
const AccordionItem = ({ header, ...rest }) => (
  <Item
    ...
    buttonProps={{
      className: ({ isEnter }) =>
        `flex w-full p-4 text-left hover:text-[#FF6500] ${
          isEnter && "text-orange-200"
        }`,
    }}
    contentProps={{
...
const FullServiceWebsite = () => {
  return (
    <div
      className="outer-div flex flex-col items-center justify-between h-[1000px] w-full mb-[150px]"
