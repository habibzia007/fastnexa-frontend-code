...
const Card = ({ title, description, image }) => {
  return (
    <div className=" shadow-sm relative  w-[287px] h-[364.3px]  hover:border  rounded-md hover:border-r-[4px] hover:border-r-orange-500 hover:border-t-[4px] hover:border-t-orange-500 transition-all duration-300 ">
