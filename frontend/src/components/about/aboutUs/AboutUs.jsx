    ...
    return (
        <div className="w-full md:py-16 pt-14 xl:px-0 px-4">
            <div
                ...
                {/* Left Side */}
                <div className="lg:mt-3 md:mb-0 mb-4 xl:w-full lg:w-[34%] mx-auto">
                    <div className="relative xl:ml-0 -ml-28">
                        <div
                            className="w-[207px] h-[276px] lg:w-[211px] lg:h-[402px] bg-[#FF6500] rounded-[18px] z-10 "></div>
                        <img
                            className="w-[207px] h-[276px] lg:w-[303px] lg:h-[402px] rounded-md absolute top-[3rem] left-[133px] lg:top-16 lg:left-[204px] z-40"
                            src={aboutus2}
                            alt=""
                ...
                <div className="flex flex-col items-center xl:items-start">
                    ...
                    <div
                        className="xl:w-auto w-full xl:mt-4 mt-10">
                        <div
                            className="border-[#ECECEC] border-b-[2px] flex gap-3 lg:gap-8 xl:w-auto w-full">
                            <Card
                                title="Expertise"
                                description="We possess expertises to navigate the ever-evolving landscape of technology."
                                border={true}
                        ...
                        <div className="border-[#ECECEC] flex gap-3 lg:gap-8 ">
                            <Card
                                title="Collaboration"
                                description="We believe in the power of collaboration and work closely with you every step."
                                border={true}
