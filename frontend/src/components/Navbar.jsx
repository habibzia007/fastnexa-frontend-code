    ...
    useEffect(() => {
        const fetchServices = async () => {
            try {
                ...
                const fetchedServices = response.data.services_sections || [];
    ...
    useEffect(() => {
        const fetchTechnology = async () => {
            try {
                ...
                const fetchedTechnology = response.data.technologies || [];

                setPrimaryLinks(prevLinks => {
                    return prevLinks.map(link => {
                        if (link.path === "/technology") {
                            return {
                                ...link,
                                dropdown: fetchedTechnology.map(tech => ({
                                    path: `/technology/${slugify(tech.technology_title, { lower: true })}/${tech.id}`,
                                    label: tech.technology_title,
                                })),
                            };
                        }
                        return link;
